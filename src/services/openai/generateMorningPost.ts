...
/** Офіційна сторінка FIFA: розклад і матчі ЧС-2026 (фільтр на збірну України вже в URL). */
...
- У тій самій футбольній частині поста (поруч із MU / Оболонь або одним коротким окремим реченням) додай **одне** коротке пояснення українською: що це посилання на офіційну сторінку FIFA з розкладом і результатами матчів Чемпіонату світу 2026 (Канада, Мексика, США), зручно подивитися ігри збірної України
...
Посилання на розклад ЧС-2026 (FIFA — матчі та рахунки; у посиланні вже обраний контекст для збірної України):
